...
public class Fp2Tests
{
    ...
    // {
    //     var a = new Fp2(new Fp([1, 2, 3, 4, 5, 6]), new Fp([7, 8, 9, 10, 11, 12]));
    //
    //     var b = new Fp2(new Fp([13, 14, 15, 16, 17, 18]), new Fp([19, 20, 21, 22, 23, 24]));
    //
    //     Assert.Equal(Fp2.Select(1, a, b), a);
    //     Assert.Equal(Fp2.Select(0, a, b), b);
    // }
    ...
    public void test_equality(Fp2 a, Fp2 b, bool expected)
    {
        ...
        Assert.Equal(b.Equals(a), expected);
        Assert.Equal(Fp2.Equal(a, b), expected);
        Assert.Equal(Fp2.Equal(b, a), expected);
        Assert.Equal(a == b, expected);
        Assert.Equal(Equals(a, b), expected);
    }
    ...
    public void test_multiplication()
    {
        ...
        Assert.Equal(Fp2.Multiply(a, b), c);
    }
    ...
    public void test_subtraction()
    {
        ...
        Assert.Equal(Fp2.Subtract(a, b), c);
    }
    ...
    public void test_sqrt()
    {
        ...
        Assert.True(Fp2.TrySqrt(a, out var sqrt));
        Assert.Equal(Fp2.Square(sqrt), a);
        ...
        Assert.True(Fp2.TrySqrt(b, out var sqrt2));
        Assert.Equal(Fp2.Square(sqrt2), b);
        ...
        Assert.True(Fp2.TrySqrt(c, out var sqrt3));
        Assert.Equal(Fp2.Square(sqrt3), c);
        ...
        Assert.False(Fp2.TrySqrt(d, out _));
    }
    ...
    public void test_inversion()
    {
        ...
        Assert.Equal(Fp2.Invert(a), b);
        Assert.Throws<DivideByZeroException>(() => Fp2.Invert(Fp2.Zero));
    }

    [Fact]
    public void test_lexicographic_largest()
    {
        Assert.False(Fp2.LexicographicallyLargest(Fp2.Zero));
        Assert.False(Fp2.LexicographicallyLargest(Fp2.One));
        ...
        Assert.True(Fp2.LexicographicallyLargest(a));
        ...
        Assert.False(Fp2.LexicographicallyLargest(b));
        ...
        Assert.False(Fp2.LexicographicallyLargest(c));
        ...
        Assert.True(Fp2.LexicographicallyLargest(d));
    }
}
