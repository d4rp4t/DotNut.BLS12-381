...
public class Fp12Tests
{
    ...
    public void test_arithmetic()
    {
        ...
        // var a = a.square().invert().unwrap().square() + c;
        // var b = b.square().invert().unwrap().square() + a;
        // var c = c.square().invert().unwrap().square() + b;

        var a1 = Fp12.Add(Fp12.Square(Fp12.Invert(Fp12.Square(a))), c);
        var b1 = Fp12.Add(Fp12.Square(Fp12.Invert(Fp12.Square(b))), a);
        var c1 = Fp12.Add(Fp12.Square(Fp12.Invert(Fp12.Square(c))), b);

        Assert.Equal(Fp12.Multiply(a1, a1), Fp12.Square(a1));
        Assert.Equal(Fp12.Multiply(b1, b1), Fp12.Square(b1));
        Assert.Equal(Fp12.Multiply(c1, c1), Fp12.Square(c1));

        Assert.Equal(
            Fp12.Multiply(Fp12.Add(a1, b1), Fp12.Square(c1)),
            Fp12.Add(
                Fp12.Multiply(Fp12.Multiply(c1, c1), a1),
                Fp12.Multiply(Fp12.Multiply(c1, c1), b1)
            )
        );

        Assert.Equal(
            Fp12.Multiply(Fp12.Invert(a1), Fp12.Invert(b1)),
            Fp12.Invert(Fp12.Multiply(a1, b1))
        );

        Assert.Equal(Fp12.Multiply(Fp12.Invert(a1), a1), Fp12.One);

        //todo finish this one also
        // Assert.NotEqual(a1, Fp12.FrobeniusMap(a1));
        // assert_eq!(
        //     a,
        //     a.frobenius_map()
        //         .frobenius_map()
