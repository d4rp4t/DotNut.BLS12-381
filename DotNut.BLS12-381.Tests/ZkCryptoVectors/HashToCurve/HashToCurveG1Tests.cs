...
public class HashToCurveG1Tests
{
    // From <https://datatracker.ietf.org/doc/html/draft-irtf-cfrg-hash-to-curve-16#appendix-J.9.2>
    public static TheoryData<string, string> Draft16_G1_Nu() => new()
    {
        {
            "",
            "184bb665c37ff561a89ec2122dd343f20e0f4cbcaec84e3c3052ea81d1834e192c426074b02ed3dca4e7676ce4ce48ba04407b8d35af4dacc809927071fc0405218f1401a6d15af775810e4e460064bcc9468beeba82fdc751be70476c888bf3"
        },
        {
            "abc",
            "009769f3ab59bfd551d53a5f846b9984c59b97d6842b20a2c565baa167945e3d026a3755b6345df8ec7e6acb6868ae6d1532c00cf61aa3d0ce3e5aa20c3b531a2abd2c770a790a2613818303c6b830ffc0ecf6c357af3317b9575c567f11cd2c"
        },
        {
            "abcdef0123456789",
            "1974dbb8e6b5d20b84df7e625e2fbfecb2cdb5f77d5eae5fb2955e5ce7313cae8364bc2fff520a6c25619739c6bdcb6a15f9897e11c6441eaa676de141c8d83c37aab8667173cbe1dfd6de74d11861b961dccebcd9d289ac633455dfcc7013a3"
        },
        {
            TestConstants.Q128,
    ...
    [Theory]
    [MemberData(nameof(Draft16_G1_Nu))]
    public void encode_to_curve_works_for_draft16_testvectors_g1_sha256_nu(string msg, string expected)
    {
        var dst = "QUUX-V01-CS02-with-BLS12381G1_XMD:SHA-256_SSWU_NU_"u8;
        var g = BLS12_381.HashToCurve.HashToCurve.EncodeToG1(Encoding.UTF8.GetBytes(msg), dst);
        Assert.True(G1Affine.TryFromUncompressed(Convert.FromHexString(expected), out var decoded));
        Assert.Equal(g, decoded);
    }
    
    // From <https://datatracker.ietf.org/doc/html/draft-irtf-cfrg-hash-to-curve-16#appendix-J.9.1>
    public static TheoryData<string, string> Draft16_G1_Ro() => new()
    {
        {
            "",
    ...
    [Theory]
    [MemberData(nameof(Draft16_G1_Ro))]
    public void hash_to_curve_works_for_draft16_testvectors_g1_sha256_ro(string msg, string expected)
    {
        var dst = "QUUX-V01-CS02-with-BLS12381G1_XMD:SHA-256_SSWU_RO_"u8;
        var g = BLS12_381.HashToCurve.HashToCurve.HashToG1(Encoding.UTF8.GetBytes(msg), dst);
        Assert.True(G1Affine.TryFromUncompressed(Convert.FromHexString(expected), out var decoded));
        Assert.Equal(g, decoded);
    }
}