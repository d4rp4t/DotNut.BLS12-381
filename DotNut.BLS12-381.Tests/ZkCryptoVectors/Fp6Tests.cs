...
public class Fp6Tests
{
    ...
    public void test_arithmetic()
    {
        ...
        Assert.Equal(Fp6.Square(a), Fp6.Multiply(a, a));
        Assert.Equal(Fp6.Square(b), Fp6.Multiply(b, b));
        Assert.Equal(Fp6.Square(c), Fp6.Multiply(c, c));

        Assert.Equal(
            Fp6.Multiply(Fp6.Add(a, b), Fp6.Square(c)),
            Fp6.Add(Fp6.Multiply(Fp6.Multiply(c, c), a), Fp6.Multiply(Fp6.Multiply(c, c), b))
        );

        Assert.Equal(Fp6.Multiply(Fp6.Invert(a), Fp6.Invert(b)), Fp6.Invert(Fp6.Multiply(a, b)));

        Assert.Equal(Fp6.Multiply(Fp6.Invert(a), a), Fp6.One);
    }
}
